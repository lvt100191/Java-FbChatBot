...
public class WebHookServlet extends HttpServlet {
	...
	public static final String PAGE_TOKEN = "EAAc2ZC66VoNUBAEaZAduZCahRhNe7uvfZAO8Mu8HZARmbOZCUr3hOBb7IXEEpMUW4cd86cSPEHxfoaSlQE8DwmfSgg3qGlXzZCU0ZCZBOvKh7CACjqYesgZB4MEhwhZC8hBRTjwQrZBGTwI3u4SKxCQC2tqCUuA9NtB3Puo6cdDlZCokF2ZCmeGBy0s4yT";
	private static final String VERIFY_TOKEN = "ohay9x";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (queryString != null) {
			System.out
			.println(" querystring not null:"	+queryString	);
